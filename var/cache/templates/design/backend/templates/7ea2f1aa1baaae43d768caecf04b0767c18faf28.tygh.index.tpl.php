<?php /* Smarty version Smarty-3.1.15, created on 2014-07-16 22:34:41
         compiled from "/home/shikon/proj/cs/design/backend/templates/views/index/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:24846186053c6c5c17737a5-99031983%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7ea2f1aa1baaae43d768caecf04b0767c18faf28' => 
    array (
      0 => '/home/shikon/proj/cs/design/backend/templates/views/index/index.tpl',
      1 => 1405209973,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '24846186053c6c5c17737a5-99031983',
  'function' => 
  array (
    'get_orders' => 
    array (
  ...
  'unifunc' => 'content_53c6c5c2d2e696_56272397',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53c6c5c2d2e696_56272397')) {function content_53c6c5c2d2e696_56272397($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/shikon/proj/cs/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_unpuny')) include '/home/shikon/proj/cs/app/functions/smarty_plugins/modifier.unpuny.php';
?><?php
...
%
    ...
    <?php if (!is_callable('smarty_modifier_date_format')) include '/home/shikon/proj/cs/app/functions/smarty_plugins/modifier.date_format.php';
...
"><?php echo $_smarty_tpl->__('show_all');?>
                ...
                <?php if (!is_callable('smarty_block_hook')) include '/home/shikon/proj/cs/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_date_format')) include '/home/shikon/proj/cs/app/functions/smarty_plugins/modifier.date_format.php';
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('no_sidebar'=>true,'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'title'=>__("dashboard"),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'tools'=>Smarty::$_smarty_vars['capture']['tools']), 0);?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['link_storefront'] = new Smarty_variable("http://".$_tmp1, null, 0);?>
        <?php } else { ?>
            <?php ob_start();?><?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['config']->value['http_location']), ENT_QUOTES, 'UTF-8');?>
<?php $_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['link_storefront'] = new Smarty_variable($_tmp2, null, 0);?>
        <?php }?>
...
" target="_blank"><?php echo $_smarty_tpl->__("welcome_screen.go_storefront");?>
                    ...
                    <a class="kbase-link" href="http://kb.cs-cart.com/installation" target="_blank"><?php echo $_smarty_tpl->__("welcome_screen.knowledge_base");?>
</a>
                </div>
            </div>
            <div class="welcome-screen-social center">
                <p>
                    <?php echo $_smarty_tpl->__("welcome_screen.thanks");?>
