<?php /* Smarty version Smarty-3.1.15, created on 2014-07-16 22:34:44
         compiled from "/home/shikon/proj/cs/design/backend/templates/common/mainbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:41896776253c6c5c43bb657-15790688%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd988719e451ed4c32c2e66c85bc068ff310b4475' => 
    array (
      0 => '/home/shikon/proj/cs/design/backend/templates/common/mainbox.tpl',
      1 => 1405209976,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '41896776253c6c5c43bb657-15790688',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53c6c5c4e791d2_73581161',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53c6c5c4e791d2_73581161')) {function content_53c6c5c4e791d2_73581161($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/shikon/proj/cs/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_block_notes')) include '/home/shikon/proj/cs/app/functions/smarty_plugins/block.notes.php';
?><?php
fn_preload_lang_vars(array('choose_action','notes'));
?>
...
<!-- Actions -->
<div class="actions cm-sticky-scroll" id="actions_panel" data-ce-top="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sticky_scroll']->value, ENT_QUOTES, 'UTF-8');?>
...
">
    <?php if (!$_smarty_tpl->tpl_vars['no_sidebar']->value) {?>
        <div class="btn-bar-left pull-left">
            ...
            <div class="pull-right adv-buttons" <?php if ($_smarty_tpl->tpl_vars['content_id']->value) {?>id="tools_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['content_id']->value, ENT_QUOTES, 'UTF-8');?>
_adv_buttons"<?php }?>>
...
<!--Content-->
<div class="content<?php if ($_smarty_tpl->tpl_vars['no_sidebar']->value) {?> content-no-sidebar<?php }?> <?php if (fn_allowed_for("ULTIMATE")) {?>ufa<?php }?>" <?php if ($_smarty_tpl->tpl_vars['box_id']->value) {?>id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['box_id']->value, ENT_QUOTES, 'UTF-8');?>
"<?php }?>>
